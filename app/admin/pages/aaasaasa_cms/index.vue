 <template>
    <div class="container mx-auto p-6">
        <header class="mb-12 text-center">
            <h1 class="text-4xl font-bold mb-4">Nuxt 4 + Tailwind CSS + Prisma ORM Architecture & Development Process</h1>
 <p class="text-xl text-gray-600">Comprehensive overview of the runtime architecture and development process</p>
        </header>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <div class="bg-white p-6 rounded-lg shadow-lg layer">
                ...
                <p class="mb-4">Nuxt 4 is a Vue.js-based framework that provides a robust architecture for building modern web applications.</p>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg layer">
                ...
                <p class="mb-4">Tailwind CSS is a utility-first CSS framework that works seamlessly with Nuxt.</p>
                <ul class="list-disc pl-5 space-y-2">
            ...
            <div class="architecture-diagram">
                <div class="mermaid">
                    ...
                    subgraph Client [Client Side]
                        UI[UI Components<br/>Vue.js + Tailwind]
                        SP[State Management<br/>Pinia]
                        R[Routing<br/>Vue Router]
                    end

                    subgraph Server [Server Side]
                        NS[Nuxt Server<br/>Nitro]
                        API[API Routes]
                        PC[Prisma Client]
                    end
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div class="space-y-6">
                <div class="p-4 bg-blue-50 rounded-lg">
                    ...
                    <div class="code-block">
                        <code>npx nuxi@latest init my-app && cd my-app<br>npm install -D tailwindcss postcss autoprefixer<br>npm install @prisma/client<br>npm install -D prisma</code>
                    </div>
                </div>
                ...
                <div class="p-4 bg-green-50 rounded-lg">
                    ...
                    <div class="code-block">
                        <code>npx prisma init<br># Edit prisma/schema.prisma to define your data model<br>npx prisma generate<br>npx prisma db push</code>
                    </div>
                </div>
