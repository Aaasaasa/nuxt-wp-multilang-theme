  ...
  <template>
      <div class="container mx-auto px-4 py-8">
          <header class="text-center mb-12">
              ...
              <p class="text-xl text-gray-600">How requests travel through layouts, middleware, and components</p>
          </header>
          ...
          <div class="bg-white p-6 rounded-lg shadow-lg mb-12">
              ...
              <div class="flow-diagram">
                  <div class="mermaid">
                      flowchart TD
                      A[Request Received] --> B[Middleware Processing]
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              <div class="bg-white p-6 rounded-lg shadow-lg step-card">
                  ...
                  <p class="mb-4">Every request starts at <code>app.vue</code>, which serves as the root component of your Nuxt application.</p>
  ...
  &lt;/template&gt;</code></pre>
              ...
              <div class="bg-white p-6 rounded-lg shadow-lg step-card">
                  ...
                  <p class="mb-4">Nuxt automatically selects a layout based on route metadata or default conventions.</p>
                  <ul class="list-disc pl-5 space-y-2">
  ...
  definePageMeta({
    layout: 'admin'
              ...
              <div class="bg-white p-6 rounded-lg shadow-lg step-card">
                  ...
                  <p class="mb-4">Middleware runs before navigation completes and can redirect or modify requests.</p>
                  <ul class="list-disc pl-5 space-y-2">
    ...
    if (!auth.isAuthenticated) {
      return navigateTo('/login')
              ...
              <div class="bg-white p-6 rounded-lg shadow-lg step-card">
                  ...
                  <p class="mb-4">The page component corresponding to the route is rendered within the layout.</p>
                  <ul class="list-disc pl-5 space-y-2">
                      <li>File-based routing: <code>pages/index.vue</code> → <code>/</code></li>
                      <li>Dynamic routes: <code>pages/users/[id].vue</code> → <code>/users/123</code></li>
  ...
  &lt;/template&gt;</code></pre>
              ...
              <div class="bg-white p-6 rounded-lg shadow-lg step-card">
                  ...
                  <p class="mb-4">Components with <code>.client.vue</code> suffix render only on the client.</p>
                  <ul class="list-disc pl-5 space-y-2">
  ...
  &lt;/script&gt;</code></pre>
              ...
              <div class="bg-white p-6 rounded-lg shadow-lg step-card">
                  ...
                  <p class="mb-4">Components with <code>.server.vue</code> suffix render only on the server.</p>
                  <ul class="list-disc pl-5 space-y-2">
