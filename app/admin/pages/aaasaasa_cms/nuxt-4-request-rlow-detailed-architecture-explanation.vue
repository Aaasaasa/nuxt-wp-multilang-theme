 ...
 <div class="container mx-auto px-4 py-8 max-w-5xl">
        <header class="text-center mb-16">
            <h1 class="text-4xl md:text-5xl font-bold mb-6 text-nuxt">Nuxt 4 Request Flow Architecture</h1>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">A comprehensive guide to the request processing pipeline in Nuxt 4 applications with detailed folder and file explanations</p>
        </header>

        <article class="bg-white rounded-xl shadow-xl p-6 md:p-8 mb-16">
            <h2 class="text-3xl font-bold mb-6 text-gray-800 border-b pb-4">Request Flow Visualization</h2>
            ...
            <div class="architecture-canvas">
                <div class="mermaid">
                    ...
                    C --> E[Return from<br/>public/ directory]
                    ...
                    subgraph DynamicRequest [Dynamic Request Processing]
                        ...
                        H --> I[Default Layout<br/>layouts/default.vue]
                        H --> J[Custom Layout<br/>e.g. layouts/admin.vue]
                        ...
                        M --> N[Server Components<br/>*.server.vue]
                        M --> O[Client Components<br/>*.client.vue]
                        M --> P[Universal Components<br/>*.vue]
                    end
            ...
            <div class="note">
                ...
                <p>The request flow differs based on whether the request is for a static asset or requires server processing. Static assets are served directly from the public/ directory, while dynamic requests go through the full processing pipeline.</p>
            </div>
        </article>

        <article class="bg-white rounded-xl shadow-xl p-6 md:p-8 mb-16">
            <h2 class="text-3xl font-bold mb-6 text-gray-800 border-b pb-4">Folder Structure & File Roles</h2>
...
└── nuxt.config.ts                   # Nuxt configuration file</pre>
        ...
        <article class="bg-white rounded-xl shadow-xl p-6 md:p-8 mb-16">
            <h2 class="text-3xl font-bold mb-6 text-gray-800 border-b pb-4">Detailed Process Explanation</h2>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="step-card bg-blue-50 p-6">
                    <h3 class="text-xl font-semibold mb-4 text-blue-800">1. Request Reception</h3>
                    <p>When a request arrives at the Nuxt server, it first determines if it's for a static asset or requires dynamic processing.</p>
                    <div class="code-block mt-4">
                        <pre>// Static assets are served directly from public/
...
// Dynamic requests proceed through the full pipeline</pre>
                ...
                <div class="step-card bg-purple-50 p-6">
                    ...
                    <p>Middleware are functions that run before navigation. They can modify the request, redirect, or cancel navigation.</p>
                    <div class="code-block mt-4">
                        <pre>// middleware/auth.global.ts
...
&lt;/template&gt;</pre>
                ...
                <div class="step-card bg-amber-50 p-6">
                    ...
                    <div class="code-block mt-4">
                        <pre>// components/DataTable.server.vue
&lt;template&gt;
...
&lt;/script&gt;</pre>
                ...
                <div class="step-card bg-emerald-50 p-6">
                    ...
                    <p>Nuxt generates the final HTML response based on the rendering mode (SSR, SPA, or Static).</p>
                    <div class="code-block mt-4">
                        <pre>// nuxt.config.ts
export default defineNuxtConfig({
  ...
  ssr: false // SPA mode
        ...
        <article class="bg-white rounded-xl shadow-xl p-6 md:p-8">
            <h2 class="text-3xl font-bold mb-6 text-gray-800 border-b pb-4">Customizing the Flow for Different URIs</h2>

            <div class="space-y-6">
                <div>
                    <h3 class="text-xl font-semibold mb-3 text-gray-700">Using Different Layouts</h3>
                    <p>To use different layouts for different URIs, specify the layout in the page component:</p>
                    <div class="code-block">
                        <pre>// pages/admin/dashboard.vue
definePageMeta({
  layout: 'admin' // Uses layouts/admin.vue
});
