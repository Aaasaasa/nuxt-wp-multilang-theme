...
h.plus = h.add = function (e) {
  ...
  if (((e = new d(e)), !a.d || !e.d))
    return (
      !a.s || !e.s
        ? (e = new d(Number.NaN))
        : a.d || (e = new d(e.d || a.s === e.s ? a : Number.NaN)),
      e
    )
...
h.precision = h.sd = function (e) {
  ...
  return (i.d ? ((n = $e(i.d)), e && i.e + 1 > n && (n = i.e + 1)) : (n = Number.NaN), n)
}
h.round = function () {
  var e = this,
    n = e.constructor
...
h.squareRoot = h.sqrt = function () {
  var e,
    ...
    l = o.constructor
  if (f !== 1 || !u || !u[0])
    return new l(!f || (f < 0 && (!u || u[0])) ? Number.NaN : u ? o : 1 / 0)
  for (
    w = !1,
      f = Math.sqrt(+o),
      f == 0 || f == 1 / 0
...
function ue(e, n, i) {
  if (n > hn) throw ((w = !0), i && (e.precision = i), new Error(Ie))
  return p(new e(se), n, 1, !0)
}
function F(e, n, i) {
  if (n > Ce) throw new Error(Ie)
...
function An(e) {
  if (!e || typeof e != 'object') throw new Error(fe + 'Object expected')
  var n,
    i,
    t,
    r = e.defaults === !0,
