...
R.precision = R.sd = function (e) {
  ...
  return (r.d ? ((t = yo(r.d)), e && r.e + 1 > t && (t = r.e + 1)) : (t = Number.NaN), t)
}
R.round = function () {
  var e = this,
    t = e.constructor
...
R.toFraction = function (e) {
  ...
  if (
    ...
    if (((a = new C(e)), !a.isInt() || a.lt(d))) throw new Error(De + a)
    e = a.gt(t) ? (o > 0 ? t : d) : a
  }
  for (
...
function Tr(e, t, r) {
  if (t > jl) throw ((_ = !0), r && (e.precision = r), new Error(mo))
  return k(new e(Pr), t, 1, !0)
}
function he(e, t, r) {
  if (t > Dn) throw new Error(mo)
...
function ou(e) {
  if (!e || typeof e != 'object') throw new Error(Ar + 'Object expected')
  var t,
    r,
    n,
    i = e.defaults === !0,
