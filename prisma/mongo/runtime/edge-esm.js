...
var Ti = Je((ze) => {
    ...
    ya = ci((e) => {
      ;((e.read = function (t, r, n, i, o) {
        ...
        if (s === 0) s = 1 - g
          ...
          if (s === d) return a ? Number.NaN : (S ? -1 : 1) * (1 / 0)
  ...
  function Aa(e, t, r, n) {
    ...
    let s
    for (s = 0; s < n; ++s) {
      let a = Number.parseInt(t.substr(s * 2, 2), 16)
      if (cn(a)) return s
      e[r + s] = a
    }
    return s
...
R.clampedTo = R.clamp = function (e, t) {
  ...
  if (e.gt(t)) throw new Error(ke + t)
...
R.comparedTo = R.cmp = function (e) {
  var t,
    ...
    l = o.s,
    d = e.s
  if (!s || !a) return !l || !d ? Number.NaN : l !== d ? l : s === a ? 0 : !s ^ (l < 0) ? 1 : -1
...
R.inverseTangent = R.atan = function () {
  ...
  if (d.isFinite()) {
    ...
    if (!d.s) return new g(Number.NaN)
...
R.logarithm = R.log = function (e) {
  ...
  if (((r = d.d), d.s < 0 || !r || !r[0] || d.eq(1)))
    return new g(r && !r[0] ? -1 / 0 : d.s != 1 ? Number.NaN : r ? 0 : 1 / 0)
  if (t)
    if (r.length > 1) o = !0
    else {
  ...
  if (((e = new S(e)), !I.d || !e.d))
    return (
      !I.s || !e.s
        ...
        : I.d
          ? (e.s = -e.s)
          : (e = new S(e.d || I.s !== e.s ? I : Number.NaN)),
      e
    )
...
R.plus = R.add = function (e) {
  ...
  if (((e = new T(e)), !h.d || !e.d))
    return (
      !h.s || !e.s
        ? (e = new T(Number.NaN))
        : h.d || (e = new T(e.d || h.s === e.s ? h : Number.NaN)),
      e
    )
...
R.precision = R.sd = function (e) {
  var t,
    r = this
  if (e !== void 0 && e !== !!e && e !== 1 && e !== 0) throw new Error(ke + e)
  return (r.d ? ((t = mo(r.d)), e && r.e + 1 > t && (t = r.e + 1)) : (t = Number.NaN), t)
}
R.round = function () {
  var e = this,
    t = e.constructor
...
R.squareRoot = R.sqrt = function () {
  var e,
    ...
    g = s.constructor
  if (d !== 1 || !a || !a[0])
    return new g(!d || (d < 0 && (!a || a[0])) ? Number.NaN : a ? s : 1 / 0)
  for (
    _ = !1,
      d = Math.sqrt(+s),
      d == 0 || d == 1 / 0
...
R.times = R.mul = function (e) {
  ...
  if (((e.s *= g.s), !T || !T[0] || !I || !I[0]))
    return new h(
      !e.s || (T && !T[0] && !I) || (I && !I[0] && !T) ? Number.NaN : !T || !I ? e.s / 0 : e.s * 0
    )
  for (
    r = X(g.e / D) + X(e.e / D),
      l = T.length,
...
R.toFraction = function (e) {
  ...
  if (
    ...
    if (((a = new C(e)), !a.isInt() || a.lt(d))) throw new Error(ke + a)
    e = a.gt(t) ? (o > 0 ? t : d) : a
  }
  for (
...
function ne(e, t, r) {
  if (e !== ~~e || e < t || e > r) throw new Error(ke + e)
}
function Rt(e, t, r, n) {
  var i, o, s, a
...
function Pr(e, t, r) {
  if (t > _l) throw ((_ = !0), r && (e.precision = r), new Error(lo))
  return k(new e(br), t, 1, !0)
}
function he(e, t, r) {
  if (t > An) throw new Error(lo)
...
function Oe(e, t) {
  ...
  if (C.s < 0 || !M || !M[0] || (!C.e && M[0] == 1 && M.length == 1))
    return new F(M && !M[0] ? -1 / 0 : C.s != 1 ? Number.NaN : M ? 0 : C)
  if (
    (t == null ? ((_ = !1), (g = O)) : (g = t),
    (F.precision = g += S),
    (r = z(M)),
...
function wo(e) {
  ...
  function i(o) {
    ...
    if (((l = typeof o), l === 'number')) {
      ...
      if (o * 0 !== 0) {
        ;(o || (d.s = Number.NaN), (d.e = Number.NaN), (d.d = null))
        return
      }
