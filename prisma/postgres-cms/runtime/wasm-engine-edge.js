...
function ce(t, e, r) {
  if (t !== ~~t || t < e || t > r) throw new Error(Oe + t)
}
function ue(t) {
  var e,
    r,
...
function Pr(t, e, r) {
  if (e > t.LN10.sd())
    throw ((q = !0), r && (t.precision = r), new Error(oe + 'LN10 precision limit exceeded'))
...
function nt(t, e) {
  var r,
    ...
    O = R.constructor,
    D = O.precision
  if (R.s < 1) throw new Error(oe + (R.s ? 'NaN' : '-Infinity'))
...
function yn(t, e) {
  ...
  if (((e = e.slice(n, i)), e)) {
    ...
    for (; n--; ) e += '0'
    if ((t.d.push(+e), q && (t.e > It || t.e < -It))) throw new Error(vr + r)
...
function L(t, e, r) {
  ...
  if (q && (t.e > It || t.e < -It)) throw new Error(vr + $(t))
  return t
}
function En(t, e) {
  var r,
...
function Pn(t) {
  ...
  function i(o) {
    ...
    } else if (typeof o != 'string') throw new Error(Oe + o)
    if ((o.charCodeAt(0) === 45 ? ((o = o.slice(1)), (s.s = -1)) : (s.s = 1), ms.test(o))) yn(s, o)
    else throw new Error(Oe + o)
  }
  if (
    ((i.prototype = S),
    (i.ROUND_UP = 0),
...
function ps(t) {
  if (!t || typeof t != 'object') throw new Error(oe + 'Object expected')
  var e,
    r,
    n,
...
var Le,
  ...
  vn = ie(() => {
    ...
    S.logarithm = S.log = function (t) {
      ...
      else if (((t = new n(t)), t.s < 1 || t.eq(te))) throw new Error(oe + 'NaN')
      if (r.s < 1) throw new Error(oe + (r.s ? 'NaN' : '-Infinity'))
    ...
    S.modulo = S.mod = function (t) {
      var e,
        ...
        n = r.constructor,
        i = n.precision
      if (((t = new n(t)), !t.s)) throw new Error(oe + 'NaN')
    ...
    S.precision = S.sd = function (t) {
      var e,
        ...
        n,
        i = this
      if (t !== void 0 && t !== !!t && t !== 1 && t !== 0) throw new Error(Oe + t)
    ...
    S.toPower = S.pow = function (t) {
      ...
      if (((a = new f(a)), !a.s)) {
        if (t.s < 1) throw new Error(oe + 'Infinity')
        return a
      }
      if (a.eq(te)) return a
      ...
      } else if (o < 0) throw new Error(oe + 'NaN')
      return (
    ...
    he = (function () {
      ...
      return function (n, i, o, s) {
        ...
        if (!i.s) throw new Error(oe + 'Division by zero')
        for (
