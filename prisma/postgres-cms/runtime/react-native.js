...
R.clampedTo = R.clamp = function (e, t) {
  ...
  if (e.gt(t)) throw new Error(qe + t)
  ...
  if (((e = new C(e)), !k.d || !e.d))
    return (
      !k.s || !e.s
        ...
        : k.d
          ? (e.s = -e.s)
          : (e = new C(e.d || k.s !== e.s ? k : Number.NaN)),
      e
    )
...
R.precision = R.sd = function (e) {
  var t,
    r = this
  if (e !== void 0 && e !== !!e && e !== 1 && e !== 0) throw new Error(qe + e)
  return (r.d ? ((t = ao(r.d)), e && r.e + 1 > t && (t = r.e + 1)) : (t = Number.NaN), t)
}
R.round = function () {
  var e = this,
    t = e.constructor
...
R.squareRoot = R.sqrt = function () {
  var e,
    ...
    g = s.constructor
  if (u !== 1 || !a || !a[0])
    return new g(!u || (u < 0 && (!a || a[0])) ? Number.NaN : a ? s : 1 / 0)
  for (
    D = !1,
      u = Math.sqrt(+s),
      u == 0 || u == 1 / 0
...
R.toFraction = function (e) {
  ...
  if (
    ...
    if (((a = new S(e)), !a.isInt() || a.lt(u))) throw new Error(qe + a)
    e = a.gt(t) ? (o > 0 ? t : u) : a
  }
  for (
...
function yr(e, t, r) {
  if (t > ru) throw ((D = !0), r && (e.precision = r), new Error(no))
  return I(new e(gr), t, 1, !0)
}
function be(e, t, r) {
  if (t > Rn) throw new Error(no)
...
function Ne(e, t) {
  ...
  if (S.s < 0 || !F || !F[0] || (!S.e && F[0] == 1 && F.length == 1))
    return new _(F && !F[0] ? -1 / 0 : S.s != 1 ? Number.NaN : F ? 0 : S)
  if (
    (t == null ? ((D = !1), (g = O)) : (g = t),
    (_.precision = g += C),
    (r = Z(F)),
...
function wu(e) {
  if (!e || typeof e != 'object') throw new Error(wr + 'Object expected')
  var t,
    r,
    n,
    i = e.defaults === !0,
