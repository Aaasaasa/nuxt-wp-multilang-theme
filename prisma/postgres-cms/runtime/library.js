...
var as = ue((Ng, ss) => {
  ...
  function Ei(e, r) {
    ...
    if ('TERM_PROGRAM' in G) {
      let n = Number.parseInt((G.TERM_PROGRAM_VERSION || '').split('.')[0], 10)
...
var cs = ue((Lg, us) => {
  ...
  function ls(e) {
    ...
    let r = (e || '').split('.').map((t) => Number.parseInt(t, 10))
...
function Cs(e) {
  let r = e.ignoreProcessEnv ? {} : process.env,
    t = (n) =>
      n.match(/(.?\$\{\w*\})/g)?.reduce(function (o, s) {
        let a = /(.?)\$\{(\w+)?\}/.exec(s)
        if (!a) return o
        let l = a[1],
          u,
...
m.clampedTo = m.clamp = function (e, r) {
  ...
  if (e.gt(r)) throw new Error(He + r)
...
m.logarithm = m.log = function (e) {
  ...
  if (((t = u.d), u.s < 0 || !t || !t[0] || u.eq(1)))
    return new c(t && !t[0] ? -1 / 0 : u.s != 1 ? Number.NaN : t ? 0 : 1 / 0)
  if (r)
    if (t.length > 1) o = !0
    else {
  ...
  if (((e = new h(e)), !f.d || !e.d))
    return (
      !f.s || !e.s
        ...
        : f.d
          ? (e.s = -e.s)
          : (e = new h(e.d || f.s !== e.s ? f : Number.NaN)),
      e
    )
...
m.plus = m.add = function (e) {
  ...
  if (((e = new d(e)), !p.d || !e.d))
    return (
      !p.s || !e.s
        ? (e = new d(Number.NaN))
        : p.d || (e = new d(e.d || p.s === e.s ? p : Number.NaN)),
      e
    )
...
m.precision = m.sd = function (e) {
  var r,
    t = this
  if (e !== void 0 && e !== !!e && e !== 1 && e !== 0) throw new Error(He + e)
  return (t.d ? ((r = Us(t.d)), e && t.e + 1 > r && (r = t.e + 1)) : (r = Number.NaN), r)
}
m.round = function () {
  var e = this,
    r = e.constructor
...
m.squareRoot = m.sqrt = function () {
  var e,
    ...
    c = s.constructor
  if (u !== 1 || !a || !a[0])
    return new c(!u || (u < 0 && (!a || a[0])) ? Number.NaN : a ? s : 1 / 0)
  for (
    w = !1,
      u = Math.sqrt(+s),
      u == 0 || u == 1 / 0
...
m.times = m.mul = function (e) {
  ...
  if (((e.s *= c.s), !d || !d[0] || !f || !f[0]))
    return new p(
      !e.s || (d && !d[0] && !f) || (f && !f[0] && !d) ? Number.NaN : !d || !f ? e.s / 0 : e.s * 0
    )
  for (
    t = X(c.e / b) + X(e.e / b),
      l = d.length,
...
m.toFraction = function (e) {
  ...
  if (
    ...
    if (((a = new g(e)), !a.isInt() || a.lt(u))) throw new Error(He + a)
    e = a.gt(r) ? (o > 0 ? r : u) : a
  }
  for (
...
function En(e, r, t) {
  if (r > vp) throw ((w = !0), t && (e.precision = t), new Error(qs))
  return y(new e(hn), r, 1, !0)
}
function xe(e, r, t) {
  if (r > Qi) throw new Error(qs)
...
function Ke(e, r) {
  ...
  if (g.s < 0 || !I || !I[0] || (!g.e && I[0] == 1 && I.length == 1))
    return new T(I && !I[0] ? -1 / 0 : g.s != 1 ? Number.NaN : I ? 0 : g)
  if (
    (r == null ? ((w = !1), (c = E)) : (c = r),
    (T.precision = c += h),
    (t = J(I)),
...
function $p(e) {
  if (!e || typeof e != 'object') throw new Error(bn + 'Object expected')
  var r,
    t,
    n,
    i = e.defaults === !0,
...
function gl(e) {
  return e ? e.replace(/".*"/g, '"X"').replace(/[\s:[]([+-]?(\d*\.)?\d+)/g, (r) => `${r[0]}5`) : ''
}
function hl(e) {
  return e
    .split(
