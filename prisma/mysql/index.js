...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = ['server/prisma/generated/mysql', 'prisma/generated/mysql']
...
path.join(
  process.cwd(),
  'server/prisma/generated/mysql/libquery_engine-debian-openssl-3.0.x.so.node'
)
// file annotations for bundling tools to include these files
path.join(__dirname, 'schema.prisma')
path.join(process.cwd(), 'server/prisma/generated/mysql/schema.prisma')
