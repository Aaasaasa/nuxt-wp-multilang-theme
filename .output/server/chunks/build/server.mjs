import { defineComponent, readonly, inject, computed, unref, defineAsyncComponent, shallowRef, ref, h, Suspense, hasInjectionContext, getCurrentInstance, provide, shallowReactive, Fragment, toRef, isRef, nextTick, mergeProps, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, getCurrentScope, withCtx, useSSRContext, Text } from 'vue';
import { j as defu, k as appendHeader, s as sanitizeStatusCode, l as getContext, f as createError$1, m as sendRedirect, n as getRequestHeaders, $ as $fetch$1, o as baseURL, q as createHooks, r as executeAsync, t as getHeader, v as toRouteMatcher, w as createRouter$1, x as destr, y as klona, z as getRequestHeader, A as isEqual$1, B as setCookie, C as getCookie, D as deleteCookie } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "login___de",
    path: "/login",
    component: () => import('./login-Bo_a70QF.mjs')
  },
  {
    name: "login___en",
    path: "/en/login",
  ...
  },
  {
    name: "admin___de",
    path: "/admin",
    component: () => import('./index-DQ2f6tB-.mjs')
  },
  {
    name: "admin___en",
    path: "/en/admin",
...
const localeLoaders = {
  "de": [{ key: "../lang/de.json", load: () => import(
    './de-CVdUytAC.mjs'
    /* webpackChunkName: "locale__srv_stranice_nuxt_wp_multilang_theme_lang_de_json" */
  ), cache: true }],
  "en": [{ key: "../lang/en.json", load: () => import(
    './en-5pctu4_k.mjs'
    /* webpackChunkName: "locale__srv_stranice_nuxt_wp_multilang_theme_lang_en_json" */
  ), cache: true }],
  "sr": [{ key: "../lang/sr.json", load: () => import(
    './sr-jv779Zz9.mjs'
    /* webpackChunkName: "locale__srv_stranice_nuxt_wp_multilang_theme_lang_sr_json" */
  ), cache: true }]
};
...
const normalizedLocales = [
  {
    ...
    "files": [
      {
        "path": "/srv/stranice/nuxt-wp-multilang-theme/lang/de.json"
      }
    ]
  },
  {
    ...
    "files": [
      {
        "path": "/srv/stranice/nuxt-wp-multilang-theme/lang/en.json"
      }
    ]
  },
  {
    ...
    "files": [
      {
        "path": "/srv/stranice/nuxt-wp-multilang-theme/lang/sr.json"
      }
    ]
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-C_oKb8Ky.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CHXNhYE4.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DW9xJl6y.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, withoutTrailingSlash as c, nuxtLinkDefaults as d, entry$1 as default, useAuth as e, __nuxt_component_0 as f, __nuxt_component_1 as g, hasProtocol as h, joinURL as j, navigateTo as n, parseQuery as p, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u, withTrailingSlash as w };
